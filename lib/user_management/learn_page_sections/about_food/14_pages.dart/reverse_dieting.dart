...
class ReverseDieting extends StatefulWidget {
  const ReverseDieting({super.key,required this.heading});
  final String heading;

  @override
  State<ReverseDieting> createState() => _ReverseDietingState();
}

class _ReverseDietingState extends State<ReverseDieting> {

final _foodNames = [
  "Chicken Breast","Salmon","Eggs","Greek Yogurt","Quinoa","Oats","Sweet Potatoes","Nuts and Seeds","Brown Rice","Avocado",
  "Cottage Cheese","Beans and Lentils","Fruits and Vegetables","Lean Beef","Tofu","Whole Grain Bread","Chia Seeds"
];
...
final _foodExplanations = [
  ...
  "Tofu is a versatile plant-based protein source that provides all essential amino acids. It is low in calories and high in nutrients like calcium and iron, making it an excellent addition to a balanced diet. Tofu can be used in a variety of dishes, from stir-fries to smoothies.",
  "Whole grain bread is a good source of complex carbohydrates and fiber, which help maintain steady energy levels and support digestion. It also provides essential nutrients like B vitamins and iron, which are important for energy production and overall health.",
  "Chia seeds are rich in omega-3 fatty acids, protein, and fiber. They help support heart health, improve digestion, and provide a sustained source of energy. Chia seeds can be added to smoothies, yogurt, or used in baking."
];
